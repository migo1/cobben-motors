                    ...
                    <ul class="nav navbar-nav d-xl-none">
                        <li class="nav-item">
                            <a
                                ...
                                ><feather type="menu" class="ficon"></feather
                            ></a>
                        </li>
                    </ul>
                    <ul class="nav navbar-nav bookmark-icons">
                        <li class="nav-item d-none d-lg-block">
                            <a
                                ...
                                data-placement="top"
                                title="Email"
                                ><feather type="mail" class="ficon"></feather
                            ></a>
                        </li>
                        <li class="nav-item d-none d-lg-block">
                            <a
                ...
                <ul class="nav navbar-nav align-items-center ml-auto">
                    ...
                    <li class="nav-item d-none d-lg-block">
                        <a class="nav-link nav-link-style"
                            ><feather type="moon" class="ficon"></feather
                        ></a>
                    </li>
                    ...
                    <li class="nav-item dropdown dropdown-notification mr-25">
                        <a
                            ...
                            href="javascript:void(0);"
                            data-toggle="dropdown"
                            ><feather type="bell" class="ficon"></feather
                            ></a
                        >
                        <ul
                    ...
                    <li class="nav-item dropdown dropdown-user">
                        ...
                        >
                            <div class="user-nav d-sm-flex d-none">
                                ...
                                ><span class="user-status">{{$page.props.user.email}}</span>
                            </div>
                            <span class="avatar"
                                ><img
                                    class="round"
                                    :src="'https://ui-avatars.com/api/?background=random&name='+$page.props.user.name"
                                    alt="avatar"
                                    height="40"
                                    width="40" /><span
