    ...
    <div class="top0">
      <div class="container">
        <div class="block-left">
          <div class="address1">
            <span aria-hidden="true" class="ei icon_pin"></span>39TH ROAD ST, NEW-YORK, US
            00123
          </div>
          <div class="phone1">
            <span aria-hidden="true" class="ei icon_phone"></span>1 - 917 - 338 - 6823
          </div>
            ...
            <header>
              <div class="logo_wrapper">
                <a href="index.html" class="logo scroll-to">
                  <img src="/customer/images/logo.png" alt="" class="img-responsive" />
                </a>
              </div>
            </header>
              ...
              <div class="navbar-collapse navbar-collapse_ collapse">
                <ul class="nav navbar-nav sf-menu clearfix">
                  <li class="sub-menu sub-menu-1">
                    <a href="#home">Home<i class="fa fa-caret-down"></i></a>
                    <ul>
                  ...
                  <li class="sub-menu sub-menu-1">
                    ...
                    <ul>
                      <li><a href="listing.html">Car Listing (right sidebar)</a></li>
                      <li><a href="listing-left.html">Car Listing (left sidebar)</a></li>
                      <li>
                        <a href="listing-without-shadow.html"
                          >Car Listing (without shadow)</a
                        >
                      </li>
                      <li><a href="details.html">Car Details (right sidebar)</a></li>
                      <li><a href="details-left.html">Car Details (left sidebar)</a></li>
                    </ul>
                  </li>
      ...
      <div id="slides_wrapper" class="">
        <div id="slides">
          <ul class="slides-container">
            <li class="nav1">
              <img src="/customer/images/slide03.jpg" alt="" class="img" />
              <div class="caption">
                <div class="container">
                  ...
                  <div class="link2">
                    <a href="details.html" class="slider-link2"
            ...
            <li class="nav2">
              <img src="/customer/images/slide04.jpg" alt="" class="img" />
              <div class="caption">
                <div class="container">
                  <div class="txt1"><span>FIND YOUR DREAM CAR</span></div>
                  <div class="txt2">AUTO 330e iPERFORMANCE</div>
                  <div class="txt4">MODEL 2017 <span>$99,000</span></div>
                  <div class="link2">
                    <a href="details.html" class="slider-link2"
                      ><span>SEE DETAILS</span></a
                    >
            ...
            <form action="javascript:;" class="form1">
                  ...
                  <div class="select1_wrapper">
                    ...
                    <div class="select1_inner">
                      <select class="select2 select" style="width: 100%">
                        ...
                        <option value="2">Agfa Toreno</option>
                        <option value="3">Astin Barton</option>
                        <option value="4">Avdi</option>
                        <option value="5">Bunesley</option>
                        <option value="6">BNQ</option>
                        <option value="7">Baratti</option>
                      </select>
                    </div>
              ...
              <div class="row">
                ...
                <div class="col3">
                  ...
                  <button type="submit" class="btn-default btn-form1-submit1">
          ...
          <div class="col-sm-4">
            <div class="thumb1">
              <div class="thumbnail clearfix">
                <figure>
                  <a href="details.html">
                    <img src="/customer/images/home01.jpg" alt="" class="img-responsive" />
                  </a>
                </figure>
                <div class="caption">
                  <div class="txt1">
                  ...
                  <div class="txt2">2010 Nord Bistang / YELLOW</div>
                  <div class="txt3">
                    Curabitur libero. Donec facilisis velit eu est. Phasellus cons quat.
                    Aenean vitae quam. Vivamus et nunc. Nunc consequ sem velde metus
                    imperdiet lacinia.
                  </div>
                  <div class="link">
                    <a href="details.html" class="btn-default btn4"
          ...
          <div class="col-sm-4">
            <div class="thumb1">
              <div class="thumbnail clearfix">
                <figure>
                  <a href="details.html">
                    <img src="/customer/images/home02.jpg" alt="" class="img-responsive" />
                  </a>
                </figure>
                <div class="caption">
                  <div class="txt1">
                  ...
                  <div class="txt2">1950 Baratti / BLACK</div>
                  <div class="txt3">
                    Curabitur libero. Donec facilisis velit eu est. Phasellus cons quat.
                    Aenean vitae quam. Vivamus et nunc. Nunc consequ sem velde metus
                    imperdiet lacinia.
          ...
          <div class="col-sm-4">
            <div class="thumb1">
              <div class="thumbnail clearfix">
                <figure>
                  <a href="details.html">
                    <img src="/customer/images/home03.jpg" alt="" class="img-responsive" />
                  </a>
                </figure>
                <div class="caption">
                  <div class="txt1">
                  ...
                  <div class="txt2">2013 Microdes C / WHITE</div>
                  <div class="txt3">
                    Curabitur libero. Donec facilisis velit eu est. Phasellus cons quat.
                    Aenean vitae quam. Vivamus et nunc. Nunc consequ sem velde metus
                    imperdiet lacinia.
    ...
    <div id="welcome">
      <div id="parallax1" class="parallax">
        ...
        <div class="parallax-content">
          <div class="container">
            <div class="logo-s">
              <img src="/customer/images/logo-s.png" alt="" class="img-responsive" />
            </div>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="txt2">
                  Lorem ipsum dolor sit amet, consectetuer adipiscing elit diam, sed diam
                  nonummy nibh “<b>euismod tincidunt</b>” ut laoreet dolore magna aliquam
                  losa volutpat. Lorem ipsum dolor sit amet, consectetuer adipiscing elit
                  diam nonummy euismod tincidunt.
                </div>
              </div>
              <div class="col-sm-6">
                <div class="txt3">
                      ...
                      <div class="thumb2">
                        <div class="thumbnail clearfix">
                          ...
                          <div class="caption">
                            ...
                            <div class="txt2">BCD M6 Sport Hybrid</div>
                      ...
                      <div class="thumb2">
                        <div class="thumbnail clearfix">
                          ...
                          <div class="caption">
                            ...
                            <div class="txt2">2016 Morraro Tittarosa</div>
                            <div class="info clearfix">
                              <span class="price">$95,900</span>
                              <span class="speed">99,000 KM</span>
                            </div>
                            <div class="txt3">Used • 2016 • Manual • Red • Petrol</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="thumb2">
                        <div class="thumbnail clearfix">
                          ...
                          <div class="caption">
                            <div class="txt1">REGISTERED 2015</div>
                            <div class="txt2">2016 Brisatti Vooron</div>
                            <div class="info clearfix">
                      ...
                      <div class="thumb2">
                        <div class="thumbnail clearfix">
                          ...
                          <div class="caption">
                            ...
                            <div class="txt2">2017 Luxus-AMD C63</div>
                            <div class="info clearfix">
                    ...
                    <div class="col-sm-4">
                      <div class="thumb2">
                        <div class="thumbnail clearfix">
                          ...
                          <div class="caption">
                            <div class="txt1">REGISTERED 2016</div>
                            <div class="txt2">Marodess - AMG</div>
                            <div class="info clearfix">
                    ...
                    <div class="col-sm-4">
                      <div class="thumb2">
                        <div class="thumbnail clearfix">
                          ...
                          <div class="caption">
                            <div class="txt1">REGISTERED 2017</div>
                            <div class="txt2">2017 Marodess - AMG</div>
                            <div class="info clearfix">
                    ...
                    <div class="col-sm-4">
                      <div class="thumb2">
                        <div class="thumbnail clearfix">
                          ...
                          <div class="caption">
                            <div class="txt1">REGISTERED 2015</div>
                            <div class="txt2">BMQ M6 Sport Hybrid</div>
                            <div class="info clearfix">
                              <span class="price">$24,380</span>
                              <span class="speed">35,000 KM</span>
                            </div>
                    ...
                    <div class="col-sm-4">
                      <div class="thumb2">
                        <div class="thumbnail clearfix">
                          ...
                          <div class="caption">
                            <div class="txt1">REGISTERED 2016</div>
                            <div class="txt2">2016 Torrari Prestalosa</div>
                            <div class="info clearfix">
                              <span class="price">$95,900</span>
                              <span class="speed">99,000 KM</span>
                            </div>
                    ...
                    <div class="col-sm-4">
                      <div class="thumb2">
                        <div class="thumbnail clearfix">
                          ...
                          <div class="caption">
                            <div class="txt1">REGISTERED 2015</div>
                            <div class="txt2">2016 Busalti Vuron</div>
                            <div class="info clearfix">
                              <span class="price">$98,995</span>
                              <span class="speed">95,000 KM</span>
                            </div>
        ...
        <div class="row">
          <div class="col-lg-5 col-lg-offset-7">
            <div class="car-inner">
              ...
              <div class="txt3">
                <p>
                  Curabitur libero. Donec facilisis velit eudsl est. Phasellus consequat.
                  Aenean vita quam. Vivamus et nunc. Nunc consequat sem velde metus
                  imperdiet lacinia. Dui estter neque molestie necd dignissim ac hendrerit
                  quis purus. Etiam sit amet vec convallis massa scelerisque mattis. Sed
                  placerat leo nec.
                </p>
                <p>
                  Ipsum midne ultrices magn eu tempor quam dolor eustrl sem. Donec quis
                  dolel Donec pede quam placerat alterl tristique faucibus posuere
                  lobortis.
                </p>
              </div>
              <ul class="ul2">
      ...
      <div class="info-wrapper">
        <div class="container">
          <div class="info-inner">
            <div class="info1">
              <div class="info1-inner animated">
                <img src="/customer/images/ic1.png" alt="" class="img1" />
                <div class="caption">
                  <div class="txt1">
                    <span
            ...
            <div class="info1">
              <div class="info1-inner animated">
                <img src="/customer/images/ic2.png" alt="" class="img1" />
                <div class="caption">
                  <div class="txt1">
                    <span
                      class="animated-number"
            ...
            <div class="info1">
              <div class="info1-inner animated">
                <img src="/customer/images/ic3.png" alt="" class="img1" />
                <div class="caption">
                  <div class="txt1">
                    <span
                      class="animated-number"
            ...
            <div class="info1">
              <div class="info1-inner animated">
                <img src="/customer/images/ic4.png" alt="" class="img1" />
                <div class="caption">
                  <div class="txt1">
                    <span
                      class="animated-number"
                          ...
                          <div class="review">
                            <div class="review_inner">
                              <div class="testimonial-wrapper">
                                <div class="txt1">
                                  <b>GEORGE SMITH,</b> Customer, BANGE RUVER Owner
                                </div>
                                <div class="txt2">
                                ...
                                <div class="txt3">
                                  Donec facilisis velit eust. Phasellus cons quat. Aenean
                                  vitae quam. Vivamus et nunc. Nunc consequsem velde metus
                                  imperdiet lacinia. Nam rutrum congue diam. Vestibulum
                                  acda risus eros auctor egestas. Morbids sem magna,
                                  viverra quis sollicitudin quis consectetuer quis nec
                                  magna.
                                </div>
                              </div>
                            </div>
                        ...
                        <li>
                          <div class="review">
                            <div class="review_inner">
                              <div class="testimonial-wrapper">
                                <div class="txt1">
                                  <b>JOHN DOE,</b> Customer, BANGE RUVER DISCOVERY Owner
                                </div>
                                <div class="txt2">
                                  <div class="img-wrapper">
                                    <img
                        ...
                        <li>
                          <div class="review">
                            <div class="review_inner">
                              <div class="testimonial-wrapper">
                                <div class="txt1">
                                  <b>AMANDA RICHARDSON,</b> Customer, BANGE RUVER Evoque
                                </div>
                                <div class="txt2">
                                  <div class="img-wrapper">
                                    <img
        ...
        <div class="bot1 clearfix">
          <div class="row">
            ...
            <div class="col-sm-3">
              ...
              <div class="autos-block">
                <div class="autos1 clearfix">
                  <figure>
                    <img src="/customer/images/latest01.jpg" alt="" class="img-responsive" />
                  </figure>
                  <div class="caption">
                ...
                <div class="autos1 clearfix">
                  <figure>
                    <img src="/customer/images/latest02.jpg" alt="" class="img-responsive" />
                  </figure>
                  <div class="caption">
                    <div class="txt1">VEHICLE NAME</div>
                    <div class="txt2">35,000 KM</div>
                ...
                <div class="autos1 clearfix">
                  <figure>
                    <img src="/customer/images/latest03.jpg" alt="" class="img-responsive" />
                  </figure>
                  <div class="caption">
                    <div class="txt1">VEHICLE NAME</div>
                    <div class="txt2">35,000 KM</div>
            ...
            <div class="col-sm-3">
              ...
              <div class="address2">
                <span aria-hidden="true" class="ei icon_pin"></span>202 W 7th St, Suite
                233 Los Angeles, California 90014 USA
              </div>

              <div class="bot1-map-wrapper">
                <div class="phone2">
                  <span aria-hidden="true" class="ei icon_phone"></span>Phone: 1-800-
                  624-5462
                </div>
                <div class="fax2">
                  <span aria-hidden="true" class="ei icon_printer"></span>FAX: 1-800-
                  624-5462
                </div>
                <div class="email2">
                  <span aria-hidden="true" class="ei icon_mail"></span>Email:
          ...
          <div class="right-block">
            <div class="social2_wrapper">
              <ul class="social2 clearfix">
                ...
                <li>
                  <a href="#"
                    ><span aria-hidden="true" class="ei social_pinterest_square"></span
                  ></a>
                </li>
                <li>
                  <a href="#"
                    ><span aria-hidden="true" class="ei social_googleplus_square"></span
                  ></a>
                </li>
                <li>
                  <a href="#"
                    ><span aria-hidden="true" class="ei social_youtube_square"></span
                  ></a>
                </li>
                <li>
                  <a href="#"
                    ><span aria-hidden="true" class="ei social_skype_square"></span
                  ></a>
                </li>
              </ul>
            </div>
          ...
          <div class="left-block">
            <div class="logo2_wrapper">
              <a href="index.html" class="logo2">
                <img src="/customer/images/logo2.png" alt="" class="img-responsive" />
              </a>
            </div>
            <div class="copyrights">&copy; 2017 Designed &amp; Powered by Mecovache</div>
          </div>
        </div>
      </div>
    </div>
